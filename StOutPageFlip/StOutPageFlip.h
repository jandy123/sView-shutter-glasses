...
class StOutPageFlip : public StWindow {
 ...
 public:
    ...
    typedef AChoreographer* (*AChoreographer_getInstance)();
    typedef void (*AChoreographer_frameCallback64)(int64_t frameTimeNanos, void* data);
    typedef void (*AChoreographer_frameCallback)(long frameTimeNanos, void* data);
    typedef void (*AChoreographer_postFrameCallback64)(AChoreographer* choreographer,
                AChoreographer_frameCallback64 callback, void* data);
  
  typedef void (*AChoreographer_postFrameCallback)(AChoreographer* choreographer,
                AChoreographer_frameCallback callback, void* data);
    AChoreographer* choreographer = 0;
    AChoreographer_postFrameCallback64 postFrameCallback = 0;
    AChoreographer_postFrameCallback postFrameCallback_old = 0;
