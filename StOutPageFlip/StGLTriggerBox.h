...
#ifndef __StGLTriggerBox_h_
#define __StGLTriggerBox_h_

#include "StGLDeviceControl.h"

class StGLTriggerBox : public StGLDeviceControl {
    ...
    ST_LOCAL StGLTriggerBox();
    ST_LOCAL virtual ~StGLTriggerBox();
    ...
    class StTriggerBoxProgram;
    StTriggerBoxProgram* myProgram;
