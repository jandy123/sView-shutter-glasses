...
class StAndroidGlue {
    ...
    //LUK: added
    ST_LOCAL inline void setRefreshRate(float rr) { refreshRate = rr; }
  
    ST_LOCAL inline float getRefreshRate() { return refreshRate; }

    //LUK: added
    ST_LOCAL inline void initializeNativeDevice(int fd) { usbFileDescriptor = fd; }
  
    ST_LOCAL inline int getUSBFileDescriptor() { return usbFileDescriptor; }
