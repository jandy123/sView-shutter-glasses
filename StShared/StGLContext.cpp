...
bool StGLContext::stglInit() {
    ...
    //LUK: added 
    assert(stglCheckExtension(anEglExts, "EGL_ANDROID_presentation_time"));
    eglPresentationTime_callback = (eglPresentationTimeANDROID)stglFindProc("eglPresentationTimeANDROID");
    assert(eglPresentationTime_callback != NULL);
